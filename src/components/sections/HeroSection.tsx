  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto px-6 md:px-12 flex flex-col items-center text-center">
        <FadeIn delay={100}>
          <div className="mb-8 font-serif text-5xl md:text-8xl tracking-widest text-foreground/90">
            MBR
          </div>
        </FadeIn>
        ...
        <FadeIn delay={300}>
          <h1 className="font-serif text-4xl md:text-6xl lg:text-7xl max-w-4xl mx-auto leading-tight mb-8 text-foreground">
            Advocacia estratégica com <span className="italic text-primary">sensibilidade</span> e
            precisão.
          </h1>
        </FadeIn>
        ...
        <FadeIn delay={500}>
          <p className="text-muted-foreground text-lg md:text-xl max-w-2xl mx-auto mb-12 font-light">
            Soluções jurídicas premium focadas em resultados, com atendimento humanizado e exclusivo
      ...
      >
        <span className="text-[10px] uppercase tracking-widest mb-2 text-muted-foreground">
          Rolar
        </span>
